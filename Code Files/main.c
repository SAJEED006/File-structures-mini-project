...
void infoScreen()
{
    ...
    printf("\t\t\t\t------------------------------------ \n\n");
    printf("\t\t\t\t\t > SAJEED MALAGI \n");
    printf("\t\t\t\t\t > AZEEM BEKINALKAR \n");
...
void endScreen()
{
    ...
    printf("\t\t\t\t   >>> Phonebook Management System <<<     \n");
    printf("\t\t\t\t------------------------------------------ \n\n");
    printf("\t\t\t\tGitHub: https://github.com/sajeed006 \n");
    printf("\t\t\t\tTwitter: https://twitter.com/sajeed \n");
    printf("\t\t\t\tLinkedIn: https://www.linkedin.com/in/sajeed-malagi-65252323a/ \n\n");
    printf("\t\t\t\t------------------------------------------ \n");
    printf("\t\t\t\t\t\tThank You. \n");
    printf("\t\t\t\t------------------------------------------ \n\n");
